defmodule LandingPageWeb.Components.Banner do
  @moduledoc """
  LandingPageWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
