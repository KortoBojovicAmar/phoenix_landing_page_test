defmodule LandingPageWeb.Components.DeviceMockup do
  @moduledoc """
  The `LandingPageWeb.Components.DeviceMockup` module provides a customizable component for displaying
  ...
  import LandingPageWeb.Components.Image, only: [image: 1]
