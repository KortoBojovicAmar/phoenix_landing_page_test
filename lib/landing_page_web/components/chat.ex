defmodule LandingPageWeb.Components.Chat do
  @moduledoc """
  `LandingPageWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
