defmodule LandingPageWeb.Components.Spinner do
  @moduledoc """
  The `LandingPageWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `LandingPageWeb.Components.Spinner` module enables developers to provide
