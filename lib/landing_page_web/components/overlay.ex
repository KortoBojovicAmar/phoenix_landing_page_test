defmodule LandingPageWeb.Components.Overlay do
  @moduledoc """
  The `LandingPageWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `LandingPageWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
