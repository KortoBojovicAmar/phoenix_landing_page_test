defmodule LandingPageWeb.Components.Menu do
  @moduledoc """
  The `LandingPageWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  import LandingPageWeb.Components.Accordion, only: [accordion: 1]
  import LandingPageWeb.Components.Button, only: [button_link: 1]
