defmodule LandingPageWeb.Components.Image do
  @moduledoc """
  The `LandingPageWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
