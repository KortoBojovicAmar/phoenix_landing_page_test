defmodule LandingPageWeb.Components.TableContent do
  @moduledoc """
  `LandingPageWeb.Components.TableContent` is a component module designed to create flexible and dynamic
