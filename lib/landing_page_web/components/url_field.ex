defmodule LandingPageWeb.Components.UrlField do
  @moduledoc """
  LandingPageWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
