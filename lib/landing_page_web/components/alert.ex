defmodule LandingPageWeb.Components.Alert do
  @moduledoc """
  LandingPageWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
