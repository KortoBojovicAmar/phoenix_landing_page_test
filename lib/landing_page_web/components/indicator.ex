defmodule LandingPageWeb.Components.Indicator do
  @moduledoc """
  The `LandingPageWeb.Components.Indicator` module provides a versatile component for visually highlighting
