defmodule LandingPageWeb.Components.MegaMenu do
  @moduledoc """
  The `LandingPageWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
