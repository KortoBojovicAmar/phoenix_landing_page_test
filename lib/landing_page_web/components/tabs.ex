defmodule LandingPageWeb.Components.Tabs do
  @moduledoc """
  `LandingPageWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import LandingPageWeb.Components.Badge, only: [badge: 1]
