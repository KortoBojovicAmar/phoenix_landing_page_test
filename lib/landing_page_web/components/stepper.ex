defmodule LandingPageWeb.Components.Stepper do
  @moduledoc """
  The `LandingPageWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `LandingPageWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
