defmodule LandingPageWeb.Components.Footer do
  @moduledoc """
  The `LandingPageWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
