defmodule LandingPageWeb.Components.Popover do
  @moduledoc """
  The `LandingPageWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
