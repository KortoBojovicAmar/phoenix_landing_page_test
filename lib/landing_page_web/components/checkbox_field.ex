defmodule LandingPageWeb.Components.CheckboxField do
  @moduledoc """
  LandingPageWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
